from .utf8 import utf8_encode, utf8_decode
...
def cp_get_entry(cp_cache, i):
	return cp_cache[0][i]

def cp_get_class(cp_cache, i):
	entry = cp_cache[0][i]
...
def cp_get_field_reference(cp_cache, i):
	entry = cp_cache[0][i]
...
def cp_get_method_reference(cp_cache, i):
	entry = cp_cache[0][i]
...
def cp_get_interface_method_reference(cp_cache, i):
	entry = cp_cache[0][i]
...
def i2cpx_utf8(cf, cp_cache, value):
	return icpx_utf8(cf, cp_cache, value).to_bytes(2)
...
def i2cpx_c(cf, cp_cache, name):
	return icpx_c(cf, cp_cache, name).to_bytes(2)
...
def i2cpx_string(cf, cp_cache, value):
	return icpx_string(cf, cp_cache, value).to_bytes(2)
...
def i2cpx_int(cf, cp_cache, value):
	return icpx_int(cf, cp_cache, value).to_bytes(2)
...
def i2cpx_long(cf, cp_cache, value):
	return icpx_long(cf, cp_cache, value).to_bytes(2)
...
def i2cpx_name_and_type(cf, cp_cache, name, desc):
	return icpx_name_and_type(cf, cp_cache, name, desc).to_bytes(2)
...
def i2cpx_f(cf, cp_cache, c_name, name, desc):
	return icpx_f(cf, cp_cache, c_name, name, desc).to_bytes(2)
...
def i2cpx_m(cf, cp_cache, c_name, name, desc):
	return icpx_m(cf, cp_cache, c_name, name, desc).to_bytes(2)
...
def i2cpx_i(cf, cp_cache, c_name, name, desc):
	return icpx_i(cf, cp_cache, c_name, name, desc).to_bytes(2)
...
def i2cpx_float(cf, cp_cache, float_bytes):
	return icpx_float(cf, cp_cache, float_bytes).to_bytes(2)
...
def i2cpx_double(cf, cp_cache, double_bytes):
	return icpx_double(cf, cp_cache, double_bytes).to_bytes(2)
