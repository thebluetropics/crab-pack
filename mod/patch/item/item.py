...
def apply_client():
	...
	cf[0x0b].extend([
		create_field(cf, cp_cache, ['public', 'static'], 'raw_squid', 'Lgm;'),
		create_field(cf, cp_cache, ['public', 'static'], 'calamari', 'Lgm;')
	])
...
def apply_server():
	...
	cf[0x0a] = (int.from_bytes(cf[0x0a]) + 2).to_bytes(2)
	cf[0x0b].extend([
		create_field(cf, cp_cache, ['public', 'static'], 'raw_squid', 'Lej;'),
		create_field(cf, cp_cache, ['public', 'static'], 'calamari', 'Lej;')
	])
